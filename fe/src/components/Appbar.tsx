        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0">
          ...
          {!user ? (
            ...
            <>
              ...
              <MenuItems
                transition
                className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-xl bg-white py-1 shadow-lg ring-1 ring-black/5 transition focus:outline-none data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in"
              >
                <MenuItem>
                  <span className="block px-4 py-2 text-lg font-semibold text-gray-700 data-[focus]:bg-gray-100 data-[focus]:outline-none rounded-t-xl">
                ...
                <MenuItem>
                  <a
                    ...
                    className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:outline-none rounded-b-xl"
                  >
                    Sign out
                  </a>
                </MenuItem>
