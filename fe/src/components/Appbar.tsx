      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden w-full md:flex md:w-auto" id="navbar-default">
          <ul className="font-medium flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8 p-4 md:p-0 bg-gray-900 md:bg-transparent border border-gray-700 md:border-0 rounded-lg md:mt-0">
            <li>
              <a href="#" className="py-2 px-3 text-white rounded-sm hover:text-blue-400">
                Home
              </a>
            </li>
            <li>
            ...
            <li className="ml-auto">
              <button
                type="button"
                className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 flex items-center"
              >
                <svg
